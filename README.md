...
3) Model Discrimination: ROC Curve Comparison (Logit vs XGBoost)
...
4) Calibration Curves (PD Accuracy — Crucial in Banking)
...
5) Strategy & Economics: Acceptance Rate vs Bad Rate / Portfolio Value
